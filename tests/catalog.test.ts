...
describe("shared catalog contract", () => {
  ...
  test("normalizes review metadata without embedding platform license/provenance", () => {
    ...
    expect(e).not.toHaveProperty("license")
    expect(e).not.toHaveProperty("provenance")
