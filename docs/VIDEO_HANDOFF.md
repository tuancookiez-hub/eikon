...
- **Format:** mp4/h264, any sane resolution ≥ 360p. Aspect is cropped to 2:1 (w:h) downstream by `eikon crop`, so keep the subject inside a centered 2:1 safe area of whatever you output. 9:16 portrait is fine.
